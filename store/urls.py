...
urlpatterns = [
    ...
    path('expenditure',views.expenditure,name='expenditure-page'),
    path('manage_expenditure',views.manage_expenditure,name='manage-expenditure'),
    path('manage_expenditure/<int:pk>',views.manage_expenditure,name='manage-expenditure-pk'),
    path('save_expenditure',views.save_expenditure,name='save-expenditure'),
    path('delete_expenditure/<int:pk>',views.delete_expenditure,name='delete-expenditure'),
    path('view_expenditure',views.view_expenditure,name='view-expenditure'),
    path('view_expenditure/<int:pk>',views.view_expenditure,name='view-expenditure-pk'),
    path('investment',views.investment,name='investment-page'),
    path('manage_investment',views.manage_investment,name='manage-investment'),
    path('manage_investment/<int:pk>',views.manage_investment,name='manage-investment-pk'),
    path('view_investment/<int:pk>',views.view_investment,name='view-investment-pk'),
    path('save_investment',views.save_investment,name='save-investment'),
    path('delete_investment/<int:pk>',views.delete_investment,name='delete-investment'),
    path('online_transaction',views.online_transaction,name='online-transaction-page'),
    path('manage_online_transaction',views.manage_online_transaction,name='manage-online-transaction'),
    path('manage_online_transaction/<int:pk>',views.manage_online_transaction,name='manage-online-transaction-pk'),
    path('view_online_transaction/<int:pk>',views.view_online_transaction,name='view-online-transaction-pk'),
    path('save_online_transaction',views.save_online_transaction,name='save-online-transaction'),
    path('delete_online_transaction/<int:pk>',views.delete_online_transaction,name='delete-online-transaction'),
    path('bank',views.bank,name='bank-page'),
    path('manage_bank',views.manage_bank,name='manage-bank'),
    path('manage_bank/<int:pk>',views.manage_bank,name='manage-bank-pk'),
    path('view_bank/<int:pk>',views.view_bank,name='view-bank-pk'),
    path('save_bank',views.save_bank,name='save-bank'),
    path('delete_bank/<int:pk>',views.delete_bank,name='delete-bank'),
    path('bank_transaction',views.bank_transaction,name='bank-transaction-page'),
    path('manage_bank_transaction',views.manage_bank_transaction,name='manage-bank-transaction'),
    path('manage_bank_transaction/<int:pk>',views.manage_bank_transaction,name='manage-bank-transaction-pk'),
